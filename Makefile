...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu Jun 28 10:35:31 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/bitcoin-reboot/src/leveldb/libleveldb.a /home/bitcoin-reboot/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/bitcoin-reboot/src/leveldb/libleveldb.a; cd /home/bitcoin-reboot/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/bitcoin-reboot/src/leveldb/libleveldb.a: FORCE
	cd /home/bitcoin-reboot/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/home/bitcoin-reboot/build/build.h: FORCE
	cd /home/bitcoin-reboot; /bin/sh share/genbuild.sh /home/bitcoin-reboot/build/build.h
