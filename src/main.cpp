...
uint256 hashGenesisBlock("0x3ee758792ff1f026540840e0a66b701f9c5729afdd7e263c2c46e35e36256e4d");
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Bitcoin Reboot: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Bitcoin Reboot: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7cc866160e547490f3ff087b11d3820fd81c50e8690f1d38044fac65d84463dc");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Trump Retreats After Border Policy Outcry";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c1de0b9dbc22e52c6e5c4c96ef4e73b6f2d1f1852a93ad6e6db63fd430c825fb3361167bfd6d737b5c9dc4c72246504f3fc26107b02e9eea99337e20dbe6b5a2") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1529705258;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086089290;

        if (fTestNet)
        {
            block.nTime    = 1529705212;
            block.nNonce   = 386675774;
        }
	...
	if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x19916a1c51c1f3ed046c24ad9a66d8ec67205679fd6e09f80e484b94cb3fa889"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xba, 0xd3 }; // Bitcoin: increase each by adding 2 to bitcoin's value.
